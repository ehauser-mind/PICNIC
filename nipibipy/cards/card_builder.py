...
class CardBuilder():
    ...
    @card.setter
    def card(self, value):
        assert value is not None, UnexpectedCardSyntaxError('Error: Must pass either a nipibipy.Card obj or str to represent the dataline')
        try:
            _ = value.datalines
            self._card = value
            ...
            if isinstance(value, str):
                ...
                raise UnexpectedCardSyntaxError('Error: Must pass either a nipibipy.Card obj or str to represent the dataline')
