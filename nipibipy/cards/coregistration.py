...
from .input_deck import CardBuilder, make_card, UnexpectedSyntaxError
from .nipype_macro_functions.fsl_flirt import flirt_coregistration
from .nipype_macro_functions.spm_register import register_coregistration
...
class Coregistration(CardBuilder):
    ...
    @card.setter
    def card(self, value):
        assert value is not None, UnexpectedSyntaxError('Error: Must pass either a nipibipy.Card obj or str to represent the dataline')
        try:
            _ = value.datalines
            self._card = value
            ...
            if isinstance(value, str):
                ...
                raise UnexpectedSyntaxError('Error: Must pass either a nipibipy.Card obj or str to represent the dataline')
